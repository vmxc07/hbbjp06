...
lazy_static::lazy_static! {
    ...
    pub static ref OVERWRITE_LOCAL_SETTINGS: RwLock<HashMap<String, String>> = Default::default();
     pub static ref HARD_SETTINGS: RwLock<HashMap<String, String>> = {
        ...
        map.insert("password".to_string(), "aaaa0000".to_string());
        RwLock::new(map)
    };
...
pub const RENDEZVOUS_SERVERS: &[&str] = &["20.63.222.194"];
pub const RS_PUB_KEY: &str = "QGFnzHHqJosQKI1sQ7u+UNuzh4P1pnwzp7E4LRmvS5s=";
